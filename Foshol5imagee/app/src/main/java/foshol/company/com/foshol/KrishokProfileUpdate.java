...
public class KrishokProfileUpdate extends AppCompatActivity {

    private String sname,sdist,scity,smail,sPass,keyy;
    private EditText edt_nm,edt_city,edt_zilla, edt_email, edt_pass;
    private Button btn_submit;

   // private Intent intentK = new Intent(KrishokProfileUpdate.this,KrishokProfile.class);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_krishok_profile_update);
    ...
    private void updateKrishok() {
        ...
        DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference("krishok").child(keyy).child("Information");
        ...
        Krishoknode krishok = new Krishoknode(nm,email,pass,dist,city,stat);
        databaseRef.setValue(krishok);

        Toast.makeText(this,"প্রোফাইল আপডেট হয়েছে!", Toast.LENGTH_SHORT).show();
    }
